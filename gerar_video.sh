...
[ -f "$BASE/template_verde.mp4" ] || { echo "ERRO: falta template_verde.mp4 no repo"; exit 1; }
...
bash "$BASE/encaixar.sh" "$BASE/template_verde.mp4" "work/$SLUG/reel.mp4" "$BASE/saidas/$SLUG.mp4"
echo "=================================================="
